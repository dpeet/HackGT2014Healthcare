...
Template.userDrugsListPage.helpers({
  userDrugsList: function(){
    var userDrugsCount = UserDrugs.find({$or:[
      ...
      {chemicalName: { $regex: Session.get('userDrugsSearchFilter'), $options: 'i' }},
      {normalDosage: { $regex: Session.get('userDrugsSearchFilter'), $options: 'i' }},
      {sideEffects: { $regex: Session.get('userDrugsSearchFilter'), $options: 'i' }},
      {personalEffect: { $regex: Session.get('userDrugsSearchFilter'), $options: 'i' }},
      {notes: { $regex: Session.get('userDrugsSearchFilter'), $options: 'i' }},
      {createdAt: { $regex: Session.get('userDrugsSearchFilter'), $options: 'i' }}
    ...
    },{limit: Session.get('userDrugsTableLimit'), skip: Session.get('userDrugsSkipCount')});
  },
  rendered: function(){
